...
@objc public protocol DZNEmptyDataSetSource : NSObjectProtocol {
    ...
    ///
    @objc optional func sectionsToIgnore(scrollView: UIScrollView) -> NSIndexSet?
    
    @objc optional func titleForEmptyDataSet(scrollView: UIScrollView) -> NSAttributedString?
    
    @objc optional func descriptionForEmptyDataSet(scrollView: UIScrollView) -> NSAttributedString?
    
    @objc optional func imageForEmptyDataSet(scrollView: UIScrollView) -> UIImage?
    
    @objc optional func imageTintColorForEmptyDataSet(scrollView: UIScrollView) -> UIImage?
    
    @objc optional func buttonTitleForEmptyDataSet(scrollView: UIScrollView, state: UIControlState) -> NSAttributedString?
    
    @objc optional func buttonImageForEmptyDataSet(scrollView: UIScrollView, state: UIControlState) -> UIImage?
    
    @objc optional func buttonBackgroundImageForEmptyDataSet(scrollView: UIScrollView, state: UIControlState) -> UIImage?
    
    @objc optional func backgroundColorForEmptyDataSet(scrollView: UIScrollView) -> UIColor?
    
    @objc optional func customViewForEmptyDataSet(scrollView: UIScrollView) -> UIImage?
    
    @objc optional func verticalOffsetForEmptyDataSet(scrollView: UIScrollView) -> CGFloat
    
    @objc optional func spaceHeightForEmptyDataSet(scrollView: UIScrollView) -> CGFloat
}

// TODO: Add documentation once completed
@objc public protocol DZNEmptyDataSetDelegate : NSObjectProtocol {
    
    @objc optional func emptyDataSetShouldDisplay(scrollView: UIScrollView) -> Bool
    
    @objc optional func emptyDataSetShouldAllowTouch(scrollView: UIScrollView) -> Bool
    
    @objc optional func emptyDataSetShouldAllowScroll(scrollView: UIScrollView) -> Bool
    
    @objc optional func emptyDataSetShouldFadeIn(scrollView: UIScrollView) -> Bool
    
    @objc optional func emptyDataSetShouldAnimateImageView(scrollView: UIScrollView) -> Bool
    
    @objc optional func emptyDataSet(scrollView: UIScrollView, didTapView: UIView)
    
    @objc optional func emptyDataSet(scrollView: UIScrollView, didTapButton: UIButton)
    
    @objc optional func emptyDataSetWillAppear(scrollView: UIScrollView)
    
    @objc optional func emptyDataSetDidAppear(scrollView: UIScrollView)
    
    @objc optional func emptyDataSetWillDisappear(scrollView: UIScrollView)
    
    @objc optional func emptyDataSetDidDisappear(scrollView: UIScrollView)
}
...
extension UIScrollView {
    ...
    public func reloadEmptyDataSet() {
        ...
        // Configure button
        if let attributedText = self.attributedButtonTitle(state: .normal), let button = view.button {
